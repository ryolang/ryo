...
- `docs/dev/` — implementation notes (see `docs/dev/AGENTS.md`)
...
**Roadmap milestone dependencies are real.** See docs/dev/AGENTS.md for the specific sequencing constraints.
