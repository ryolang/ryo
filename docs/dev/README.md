...
| [architecture_analysis.md](architecture_analysis.md) | Verified snapshot of the full compiler architecture (data structures per stage, ranked weaknesses) + tiered improvement roadmap; source of a tranche of ISSUES.md entries | **Keep as reference**; implement roadmap tiers per ISSUES.md — refresh or delete when stale |
