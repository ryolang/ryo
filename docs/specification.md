...
### 5.9 Borrow Checker Algorithm (Sketch — Draft)
...
#### 5.9.2 Rule 2 — Implicit Borrow for Parameters
...
#### 5.9.3 Rules 5 & 6 — Early Rejection (AST/Type Check Phase)
...
#### 5.9.4 Scope-Locked View Validation (Section 5.7 Enforcement)
...
#### 6.2.6 Closure Representation and ABI (Draft — v0.2+)

This subsection specifies the memory representation and calling conventions for closures. It complements the semantic rules in 6.2.2–6.2.3 with implementation-level details required for code generation and FFI interoperability.
...
*   **~~Precise Borrow Checker Algorithm Specification~~** — Sketch in Section 5.9. Formal specification deferred to implementation phase.
*   **~~Precise Closure Representation/ABI~~** — Draft in Section 6.2.6. Full ABI specification deferred to v0.2+ FFI milestone.
