...
**Files:** `Cargo.toml` (workspace deps), `Cargo.lock`, `scripts/check_cranelift.sh`, `ryo-backend/src/codegen/`
...
**Files:** `ryo-backend/src/codegen/expr.rs` (`emit_panic_guard` and the checked-arithmetic/div-zero call sites)
