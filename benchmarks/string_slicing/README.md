...
|---|---|---|---|
| **Rust** | 1.7 ms ± 0.2 ms | 1.00x | 2.88 MB |
| **Swift** | 2.6 ms ± 0.2 ms | 1.54x slower | 7.09 MB |
| **Ryo (AOT)** | 4.9 ms ± 0.3 ms | 2.94x slower | 2.75 MB |
| **Ryo (JIT)** | 6.5 ms ± 0.4 ms | 3.90x slower | 6.62 MB |
