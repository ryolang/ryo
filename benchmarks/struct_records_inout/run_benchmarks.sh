...
rustc -O struct_records_inout.rs -o struct_records_inout_rs
swiftc -O struct_records_inout.swift -o struct_records_inout_swift
go build -o struct_records_inout_go struct_records_inout.go
ryo_bin="../../target/release/ryo"
$ryo_bin build struct_records_inout.ryo > /dev/null
...
measure_mem "Rust" ./struct_records_inout_rs
measure_mem "Swift" ./struct_records_inout_swift
measure_mem "Go" ./struct_records_inout_go
measure_mem "Python" python3 struct_records_inout.py
measure_mem "Ryo (AOT)" ./struct_records_inout
measure_mem "Ryo (JIT)" $ryo_bin run struct_records_inout.ryo

echo ""
echo "-------------------"
echo "Running Benchmarks (500,000 record build-mutate-score rounds) using hyperfine"
echo "-------------------"

hyperfine --warmup 3 --shell=none \
  './struct_records_inout_rs' \
  './struct_records_inout_swift' \
  './struct_records_inout_go' \
  'python3 struct_records_inout.py' \
  './struct_records_inout' \
  "$ryo_bin run struct_records_inout.ryo"
