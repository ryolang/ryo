...
rustc -O struct_records_reuse.rs -o struct_records_reuse_rs
swiftc -O struct_records_reuse.swift -o struct_records_reuse_swift
go build -o struct_records_reuse_go struct_records_reuse.go
ryo_bin="../../target/release/ryo"
$ryo_bin build struct_records_reuse.ryo > /dev/null
...
measure_mem "Rust" ./struct_records_reuse_rs
measure_mem "Swift" ./struct_records_reuse_swift
measure_mem "Go" ./struct_records_reuse_go
measure_mem "Python" python3 struct_records_reuse.py
measure_mem "Ryo (AOT)" ./struct_records_reuse
measure_mem "Ryo (JIT)" $ryo_bin run struct_records_reuse.ryo

echo ""
echo "-------------------"
echo "Running Benchmarks (500,000 record build-update-reuse rounds) using hyperfine"
echo "-------------------"

hyperfine --warmup 3 --shell=none \
  './struct_records_reuse_rs' \
  './struct_records_reuse_swift' \
  './struct_records_reuse_go' \
  'python3 struct_records_reuse.py' \
  './struct_records_reuse' \
  "$ryo_bin run struct_records_reuse.ryo"
