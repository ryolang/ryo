...
rustc -O byte_slicing.rs -o byte_slicing_rs
swiftc -O byte_slicing.swift -o byte_slicing_swift
ryo_bin="../../target/release/ryo"
$ryo_bin build byte_slicing.ryo > /dev/null
...
measure_mem "Rust" ./byte_slicing_rs
measure_mem "Swift" ./byte_slicing_swift
measure_mem "Ryo (AOT)" ./byte_slicing
measure_mem "Ryo (JIT)" $ryo_bin run byte_slicing.ryo

echo ""
echo "-------------------"
echo "Running Benchmarks (scan 688 KiB via views, count 16384 matches) using hyperfine"
echo "-------------------"
